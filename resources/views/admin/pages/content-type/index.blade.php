    ...
    <div class="g-hidden-sm-down g-bg-gray-light-v8 g-pa-20">
        <ul class="u-list-inline g-color-gray-dark-v6">
            ...
            <li class="list-inline-item">
                <span class="g-valign-middle">Tipos de conteúdos</span>
            </li>
        </ul>
    </div>
    ...
    <div class="g-pa-20">
        <div class="media">
            <div class="d-flex align-self-center">
                <h1 class="g-font-weight-300 g-font-size-28 g-color-black mb-0">Tipos de conteúdos</h1>
            </div>

            <div class="media-body align-self-center text-right">
                <a class="btn btn-xl u-btn-secondary g-width-160--md g-font-size-default g-ml-10" href="{{ route('admin.content-type.create')}}">Adicionar novo
                </a>
            </div>
        </div>
            ...
            <table class="table u-table--v3 g-color-black">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ date('d/m/Y H:i:s', strtotime($contentType->created_at))}}</td>
                        <td>{{ date('d/m/Y H:i:s', strtotime($contentType->updated_at)) }}</td>
                        <td>
                            <div class="g-pos-rel g-top-3 d-inline-block">
                                <a class="u-link-v5 g-color-gray-light-v6 g-color-secondary--hover g-mr-15" href="{{ route('admin.content-type.edit', $contentType->slug) }}">
                                    <i class="hs-admin-pencil g-font-size-18"></i>
                                </a>

                                <a class="u-link-v5 g-color-gray-light-v6 g-color-secondary--hover" href="{{ route('admin.content-type.destroy', $contentType->slug) }}">
