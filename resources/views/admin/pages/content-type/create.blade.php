            ...
            <div class="g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md g-mb-30">
                ...
                <div class="form-group g-mb-30">
                    ...
                    <div class="g-pos-rel">
                        ...
                        <input name="name" class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-py-10" type="text" placeholder="Nome do tipo de conteúdo">
                    </div>
                </div>
            </div>
