    ...
    <div class="g-pa-20">
        <div class="media">
            <div class="d-flex align-self-center">
                <h1 class="g-font-weight-300 g-font-size-28 g-color-black mb-0">Lista de Usuários</h1>
            </div>
        </div>
...
{{--                                <a class="u-link-v5 g-color-gray-light-v6 g-color-secondary--hover g-mr-15" href="{{ route('admin.user.edit', $user->id) }}">--}}
{{--                                    <i class="hs-admin-pencil g-font-size-18"></i>--}}
{{--                                </a>--}}

{{--                                <a class="u-link-v5 g-color-gray-light-v6 g-color-secondary--hover" href="{{ route('admin.user.destroy', $user->id) }}">--}}
